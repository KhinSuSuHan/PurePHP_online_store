	...
	<div class="row">
		<div class="offset-md-2 col-md-8">
			<form method="POST" action="updateitem.php" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label>Photo</label>
					<input type="file" name="item_logo" 
					class="form-control-file">
					<img src="<?=$item['photo']?>" width="200" height="120"
					class="mt-3">
					<input type="hidden" name="oldphoto" value="<?=$item['photo']?>">	
				</div>
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					<li class="nav-item" role="presentation">
						<a class="nav-link active" id="home-tab" data-toggle="tab" href="#price" role="tab" aria-controls="home" aria-selected="true">
						Price</a>
					</li>
					<li class="nav-item" role="presentation">
				...
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="price" role="tabpanel" aria-labelledby="home-tab">
						<div class="form-group my-3">
							...
							class="form-control" value="<?=$item['price']?>">	</div>
						</div>
